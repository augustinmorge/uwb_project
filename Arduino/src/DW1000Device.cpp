...
// void DW1000Device::setStartTime(uint32_t millis) { _startTime = millis; }
void DW1000Device::setValidTime(uint32_t millis) { _validTime = millis;}

void DW1000Device::setRange(float range) { _range = round(range*100.0f); }

void DW1000Device::setRXPower(float RXPower) { _RXPower = round(RXPower*100.0f); }

void DW1000Device::setFPPower(float FPPower) { _FPPower = round(FPPower*100.0f); }

void DW1000Device::setQuality(float quality) { _quality = round(quality*100.0f); }
...
uint32_t DW1000Device::getValidTime() { return _validTime; }
