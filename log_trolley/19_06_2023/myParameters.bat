...
if %errorlevel% equ 0 (
    ...
    echo.
    "C:\Program Files (x86)\iXblue\Delph INS Research & Development\Postproins\PostproIns.exe" "C:\Users\augustin.morge\Documents\uwb_project\log_trolley\19_06_2023\19_06_2023_PH-2248_A_POSTPROCESSING-parameters.xml"
    goto end
)
