...
filename = '19_06_2023_PH-2248_A_POSTPROCESSING-ins.xpf.txt'
file_name = f"19_06_2023\\{filename}"
...
new_file_anchor_path = os.path.join(current_directory, f"19_06_2023\\anchor_{filename}")
