...
set "xmlFile=C:\Users\augustin.morge\Documents\uwb_project\log_trolley\06_06_2023\chariot_3roues\chariot_3roues_PH-2248_A_POSTPROCESSING-parameters.xml"
...
if %errorlevel% equ 0 (
    ...
    echo.
    C:\"Program Files (x86)\iXblue\Delph INS Research & Development\Postproins\PostproIns.exe"  C:\Users\augustin.morge\Documents\uwb_project\log_trolley\06_06_2023\chariot_3roues\chariot_3roues_PH-2248_A_POSTPROCESSING-parameters.xml
    goto end
)
