    ...
    for filename in filenames:
        ...
        for i in range(2):
            for j in range(2):
                ...
                ax.set_xlabel("Measured Range (m)",fontsize=12)
        ...
        if calibrate:
            ...
            for i in range(2):
                for j in range(2):
                    idx = 2 * i + j
                    ax = axs[i, j]
                    ax.set_title(f"Anchor {80+2*i+j}",fontsize=12)
                    ax.set_xlabel("valeurs initiales prises",fontsize=12)
                    ax.set_ylabel("Erreurs",fontsize=12)
                    ax.set_ylim([0, 10])
