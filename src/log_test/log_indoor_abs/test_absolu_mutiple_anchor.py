...
if doing_test:
    ...
    if False: #udp == 'y':
        ...
        from log_data_serial_anchor import *

        print("Start test..")
        file = open(f"{THIS_FOLDER}/serial/{date_str}_Serial_Test_multiple_points.csv", "w")
        file.write("n°anchor; d_real [m]; time [ms]; d_measured [m]; RX [dbm]; FP [dbm]; Q; timePollSent; timePollReceived; timePollAckAckSent; timePollAckReceived; timeRangeSent; timeRangeReceived\n")
